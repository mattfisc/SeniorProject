        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger disabled" href="#" tabindex="-1" aria-disabled="true" href="home.php">Home</a></li>
            ...
            <div>
              <a href="profile/member_only.php"><img src="img/user.png" width="30" height="30" class="d-inline-block align-top" alt="" id="pName">
                <?php
                session_start();
                echo "Hello ";
